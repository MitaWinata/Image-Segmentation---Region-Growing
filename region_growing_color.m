function [segmented_image, region_total, e] = region_growing_color(I, threshold, neighbours )
%%
...
% Define a queue to store the evaluation sequence
queue = [];
queue_last = 1;
queue(1,:) = seed_point;
